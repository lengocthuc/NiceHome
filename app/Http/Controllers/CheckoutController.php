...
class CheckoutController extends Controller
{
    ...
    public function save_cart(Request $request){
        ...
        if (count($carts) === 0) {
            ...
            $amount_mail = $thongtintuuser["total_received"];
            Mail::send('front-end.sendmail', compact('name_mail', 'amount_mail'), function($email) use($name_mail, $receive_mail, $amount_mail){
