                                      ...
                                      <div id="collapseThree" class="collapse show" data-parent="#accordionExample">
                                          <div class="card-body">
                                              <div class="shop__sidebar__price">
                                                  <ul>
                                                      <li><a class="@if($price==-1) {{'active'}} @endif" href="/shop-search?priceBegin=-1&priceEnd=10000000000&page=1">Bỏ lọc</a></li>
                                                      <li><a class="@if($price==0) {{'active'}} @endif" href="/shop-search?priceBegin=0&priceEnd=1000000&page=1">0đ - 1.000.000</a></li>
                                                      <li><a class="@if($price==1000000) {{'active'}} @endif" href="/shop-search?priceBegin=1000000&priceEnd=10000000&page=1">1.000.000 - 10.000.000</a></li>
                                                      <li><a class="@if($price==10000000) {{'active'}} @endif" href="/shop-search?priceBegin=10000000&priceEnd=50000000&page=1">10.000.000 - 50.000.000</a></li>
                                                      <li><a class="@if($price==50000000) {{'active'}} @endif" href="/shop-search?priceBegin=50000000&page=1">50.000.000+</a></li>
                                                  </ul>
                                              </div>
                                          </div>
                                      </div>
