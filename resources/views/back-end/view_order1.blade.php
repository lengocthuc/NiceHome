                                    ...
                                    <tbody>
                                        @foreach($orders as $order)
	                                        <tr>
                                                ...
                                                <td data-label="Tổng tiền">{{number_format($order->total_received)}}</td>
                                                <td data-label="Thanh toán">{{$order->status}}</td>
                                                <td data-label="Giao hàng thành công" class="right__iconTable"><a onclick="myFunction1({{$order->id}})"><img src="/assets/icon-return.svg" alt=""></a></td>
